...
# Network
# ip   = 5.17.0.0       00000101.00010001.00000000.00000000
# mask = 255.254.0.0    11111111.11111110.00000000.00000000
#print('')
# ip's oktet
#print(oktet_1_for_ip)
#print(oktet_2_for_ip)
#print(oktet_3_for_ip)
#print(oktet_4_for_ip)
#print('')
# masmk's oktet
#print(oktet_1_for_mask)
#print(oktet_2_for_mask)
#print(oktet_3_for_mask)
#print(oktet_4_for_mask)
...
#print(oktket_1_for_ip)
#print(oktet_1_for_mask)
#print('')
#print(network_oktet_1)
#print(network_oktet_2)
#print(network_oktet_3)
#print(network_oktet_4)
...
#print('')
#print(network_1_oktet_str)
#print(network_2_oktet_str)
#print(network_3_oktet_str)
#print(network_4_oktet_str)
...
#   print(summ_network_done)

#print(wildcard_1_oktet_str)
#print(network_1_oktet_str)
...
# ip min
#    print(network_done_oktet_1_min)
#    print(network_done_oktet_2_min)
#    print(network_done_oktet_3_min)
#    print(network_done_oktet_4_min)

#    print('')

# ip max 
#    print(network_done_oktet_1)
#    print(network_done_oktet_2)
#    print(network_done_oktet_3)
#    print(network_done_oktet_4)
...
#                   print(str(network_done_oktet_1_min) + '.' + str(oktet_2) + '.' + str(oktet_3) + '.' + str(oktet_4))
                    write_ip.write(str(network_done_oktet_1_min) + '.' + str(oktet_2) + '.' + str(oktet_3) + '.' + str(oktet_4) + '\n')

    elif network_done_oktet_3_min < network_done_oktet_3:
        for oktet_3 in range(network_done_oktet_3_min,network_done_oktet_3+1):
            for oktet_4 in range(network_done_oktet_4_min,network_done_oktet_4+1):
#               print(str(network_done_oktet_1_min) + '.' + str(network_done_oktet_2_min) + '.' + str(oktet_3) + '.' + str(oktet_4))
        ...
        for oktet_4 in range(network_done_oktet_4_min,network_done_oktet_4+1):
#           print(str(network_done_oktet_1_min) + '.' + str(network_done_oktet_2_min) + '.' + str(network_done_oktet_3_min) + '.' + str(oktet_4))
...
for txt_port in ports:
  ...
  result_port_txt_file.write(txt_port + '\n')
